          ...
          <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-sm mt-2">
                Sign in with your OAU Google account to create or manage your staff profile
              </p>
            </div>
            ...
            >
              ...
              Sign in with OAU Google Account
            </Button>

            <p className="text-center text-xs text-muted-foreground mt-6">
              Only <span className="font-semibold">@oauife.edu.ng</span> accounts are allowed
            </p>
          </div>
        </motion.div>
      </section>
